...
class AsyncHelper(QObject):
    ...
    def __init__(self, worker, entry, start_signal, end_signal):
        super().__init__()
        ...
        getattr(self.worker, start_signal).connect(self.on_worker_started)
        getattr(self.worker, end_signal).connect(self.on_worker_done)
